...
def build_step_preview_beep(panel, context):
    ...
    _add_description(sizer, panel, [
        ...
        _("다른 앱으로 옮기면 두 음이 울려요. 첫 음은 '어떤 앱'인지, 두 번째 음은 '그 앱 안의 어떤 창'인지 알려줘요."),
        _("같은 앱 안에서 창이나 탭을 바꿀 때는 두 번째 음만 짧게 울려요. 어떤 앱인지는 이미 알고 있으니까요."),
        _("미리듣기 버튼은 두 음을 모두 들려줘서 어떤 식으로 구성됐는지 확인할 수 있어요."),
