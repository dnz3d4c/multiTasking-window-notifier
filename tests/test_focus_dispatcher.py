...
def tab_classes_noop(monkeypatch):
    ...
    monkeypatch.setattr(eventRouter.tabClasses, "is_overlay_class", lambda appId, wcn: False)
    monkeypatch.setattr(eventRouter.tabClasses, "is_editor_class", lambda appId, wcn: False)
